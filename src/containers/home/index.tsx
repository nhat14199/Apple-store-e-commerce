...
function Home() {
  ...
  const dataSell = [
    ...
    },
    {
      ...
      title: "New",
      discribe: " HomePod - Midnight",
      price: "$99.00",
      type: 2,
    },
    {
      image:
        "https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/airpods-max-select-silver-202011?wid=400&hei=400&fmt=jpeg&qlt=90&.v=1604021221000",
      title: "Free Engraving",
      discribe: "AirPods Max - Silver",
      price: "$549.00",
      type: 2,
    },
    {
      ...
      title: "Free Engraving",
      discribe: "AirPods (3rd generation) with Lightning Charging Case",
      price: "$169.00",
      type: 2,
    },
    {
      image:
        "https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/MQLK3?wid=400&hei=400&fmt=jpeg&qlt=90&.v=1682361480894",
      title: "New",
      discribe:
  ...
  const titleSellOne = " Loud and clear.";
  const titleSellTwo = "Unparalleled choices for rich, high-quality sound.";
  ...
  const Accessories = [
    ...
    {
      image:
        "https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/MTJC3ref?wid=400&hei=400&fmt=jpeg&qlt=90&.v=1692936507700",
      title: "New",
      discribe: "45mm Evergreen Magnetic Link - M/L",
      price: "$59.00",
      type: 2,
    },
    {
      image:
        "https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/MUH73ref?wid=400&hei=400&fmt=jpeg&qlt=90&.v=1692936516435",
      title: "New",
      discribe: "45mm Evergreen Magnetic Link - M/L",
      price: "$149.00",
      type: 2,
    ...
    {
      image:
        "https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/MT2H3?wid=400&hei=400&fmt=jpeg&qlt=90&.v=1692915693368",
      title: "New",
      discribe: "AirTag FineWoven Key Ring - Black",
      price: "$39.00",
      type: 2,
    },
  ];
  const tittleAccessOne = "Accessories. ";
  const tittleAccessTow =
  ...
  return (
    <div className="bg-slate-50">
      ...
      <ShapeSquare
        data={Accessories}
        titleOne={tittleAccessOne}
        titleTwo={tittleAccessTow}
      />
      <ShapeSquare
        data={dataSell}
        titleOne={titleSellOne}
        titleTwo={titleSellTwo}
      />
      <CardShapeSquare
        data={experience}
